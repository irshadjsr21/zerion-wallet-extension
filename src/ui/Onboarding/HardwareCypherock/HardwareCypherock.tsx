...
import {
  FrameLayout,
  HardwareWalletCypherockConnectionStart,
} from 'src/ui/pages/HardwareWalletCypherockConnection/HardwareWalletCypherockConnection';
...
export function HardwareCypherock() {
  ...
  return view === ViewParam.hardware ? (
    <PageLayout hardwareImportStyle={true}>
      <FrameLayout>
        <HardwareWalletCypherockConnectionStart onImport={handleImport} />
      </FrameLayout>
    </PageLayout>
  ) : (
    <PageLayout>
