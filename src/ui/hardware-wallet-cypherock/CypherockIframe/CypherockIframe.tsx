...
export const CypherockIframe = React.forwardRef(function LedgerIframeComponent(
  {
    appSearchParams,
    initialRoute = '/',
    style,
  ...
  return (
    <iframe
      ...
      allow="usb"
      src={`ui/hardware-wallet-cypherock/cypherock.html?theme-state=${encodeURIComponent(
